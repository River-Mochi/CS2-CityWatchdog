...
export const disableMoneyTooltips$ = bindValue<boolean>(mod.id, "DisableMoneyTooltips", false);
...
export const OnDisableMoneyTooltipsToggle = (disable: boolean) => trigger(mod.id, "DisableMoneyTooltips", disable);
