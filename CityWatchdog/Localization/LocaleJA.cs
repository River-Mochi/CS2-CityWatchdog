    ...
    public sealed class LocaleJA : IDictionarySource
    {
            ...
            Dictionary<string, int> indexCounts)
        {
            ...
            Dictionary<string, string> entries = new Dictionary<string, string>
            {
                ...
                { m_Settings.GetOptionGroupLocaleID(CwdSettings.MoneyViewGroup), "都市内情報表示" },
                { m_Settings.GetOptionGroupLocaleID(CwdSettings.MiniHudGroup), "ミニHUD通知" },
                { m_Settings.GetOptionGroupLocaleID(CwdSettings.Milestone), "新規都市スタート設定" },
                { m_Settings.GetOptionGroupLocaleID(CwdSettings.Money), "資金" },
                { m_Settings.GetOptionGroupLocaleID(CwdSettings.SaveConversion), "無限資金セーブ変換" },
                { m_Settings.GetOptionGroupLocaleID(CwdSettings.AboutInfo), "" },
                { m_Settings.GetOptionGroupLocaleID(CwdSettings.AboutLinks), "" },
                { m_Settings.GetOptionGroupLocaleID(CwdSettings.AboutDiagnostics), "診断" },
                ...
                { m_Settings.GetBindingKeyLocaleID(CwdSettings.ToggleNotificationsAction), "全通知アイコンを即表示/非表示" },
