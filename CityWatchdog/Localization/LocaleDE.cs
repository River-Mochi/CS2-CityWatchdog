    ...
    public sealed class LocaleDE : IDictionarySource
    {
            ...
            Dictionary<string, int> indexCounts)
        {
            ...
            Dictionary<string, string> entries = new Dictionary<string, string>
            {
                ...
                { m_Settings.GetOptionDescLocaleID(nameof(Setting.ToggleNotificationsKeyboardBinding)), "<Hotkey> für dieselbe Aktion wie der <[TOGGLE ALL]>-Button im Spiel.\n" +
                ...
                { m_Settings.GetOptionDescLocaleID(nameof(Setting.ToggleRoadNamesKeyboardBinding)), "<Hotkey> zum sofortigen Aus- oder Einblenden der Vanilla-Straßennamen.\n" +
                ...
                { m_Settings.GetOptionDescLocaleID(nameof(Setting.ToggleAllTooltipsKeyboardBinding)), "<Hotkey> zum Aus- oder Einblenden ALLER Spiel-Hover-Tooltips — Gebäude, Cims, Werkzeuge und untere Menüicons.\n" +
                ...
                { m_Settings.GetOptionDescLocaleID(nameof(Setting.MoneyView)), "<Empfohlen>\n" +
                ...
                { m_Settings.GetOptionDescLocaleID(nameof(Setting.MoneyViewMode)), "Wähle, ob Trends stündlich oder monatlich für Geld und Bevölkerung angezeigt werden.\n" +
                ...
                { m_Settings.GetOptionDescLocaleID(nameof(Setting.MoneyTooltipMode)), "Wähle, wie viele Details im Geld-Tooltip erscheinen.\n" +
                ...
                { m_Settings.GetOptionDescLocaleID(nameof(Setting.MoneyTooltipFontScale)), "Passt die <Schriftgröße> der Money-View-Zahlen an.\n" +
                    "Spielstandard = 100%\n" +
                    "<Mod-Standard = 120%>\n" +
                ...
                { m_Settings.GetOptionDescLocaleID(nameof(Setting.PopulationTooltipFontScale)), "Passt die <Schriftgröße> der Bevölkerungszahlen an.\n" +
                    "Spielstandard = 100%\n" +
                    "<Mod-Standard = 120%>\n" +
                ...
                { m_Settings.GetOptionDescLocaleID(nameof(Setting.MiniHudEnabled)), "Zeigt ein kleines HUD in der Stadt mit den wichtigsten Benachrichtigungszahlen.\n" +
                ...
                { m_Settings.GetOptionDescLocaleID(nameof(Setting.MiniHudItemCount)), "Wähle, wie viele Benachrichtigungsicons das Mini-HUD gleichzeitig zeigen kann." },

                { m_Settings.GetOptionLabelLocaleID(nameof(Setting.MiniHudOrientation)), "Mini-HUD-Ausrichtung" },
                { m_Settings.GetOptionDescLocaleID(nameof(Setting.MiniHudOrientation)), "Wähle, ob die Mini-HUD-Icons als Reihe oder Spalte angeordnet werden." },
                ...
                { m_Settings.GetOptionDescLocaleID(nameof(Setting.MiniHudHideZero)), "Wenn aktiviert [ ✓ ], blendet das Mini-HUD Benachrichtigungszeilen mit 0 aus." },

                { m_Settings.GetOptionLabelLocaleID(nameof(Setting.MiniHudGlassStyle)), "Glas-Stil" },
                { m_Settings.GetOptionDescLocaleID(nameof(Setting.MiniHudGlassStyle)), "Fügt zur besseren Lesbarkeit einen weichen glasartigen Hintergrund hinter dem Mini-HUD hinzu." },
                ...
                { m_Settings.GetOptionDescLocaleID(nameof(Setting.InitialMoney)), "Legt den Startbetrag für eine neue Stadt mit <begrenztem Geld> oder die erste geladene Stadt fest\n" +
                ...
                { m_Settings.GetOptionDescLocaleID(nameof(Setting.CustomMilestone)), "<Vor dem Laden oder Starten einer Stadt> aktivieren, um den gewählten Meilenstein nach dem Laden freizuschalten.\n" +
                ...
                { m_Settings.GetOptionDescLocaleID(nameof(Setting.MilestoneLevel)), "Wähle den Meilenstein für das nächste Laden einer Stadt.\n" +
                ...
                { m_Settings.GetOptionDescLocaleID(nameof(Setting.ManualMoneyAmount)), "Dieser Betrag wird mit den Hotkeys Geld hinzufügen und Geld abziehen genutzt.\n" +
                    "<Mod-Standard = 40,000>\n" +
                ...
                { m_Settings.GetOptionDescLocaleID(nameof(Setting.AutomaticAddMoney)), "Wenn aktiv [ ✓ ], prüft City Watchdog das Stadtguthaben bei geladener Stadt.\n" +
                ...
                { m_Settings.GetOptionDescLocaleID(nameof(Setting.AutomaticAddMoneyThreshold)), "Wenn automatisches Geld aktiv ist und das Guthaben unter diesen Wert fällt,\n" +
                ...
                { m_Settings.GetOptionDescLocaleID(nameof(Setting.AutomaticAddMoneyAmount)), "Betrag, der jedes Mal hinzugefügt wird.\n" +
                ...
                { m_Settings.GetOptionDescLocaleID(nameof(Setting.ConfirmUnlimitedMoneySaveConversion)), "<Erst ein Backup der Stadt machen>.\n" +
                ...
                { m_Settings.GetOptionDescLocaleID(nameof(Setting.ConvertUnlimitedMoneySave)), "Für Städte, die mit <Unbegrenztes Geld> gestartet wurden.\n" +
                ...
                { m_Settings.GetOptionWarningLocaleID(nameof(Setting.ConvertUnlimitedMoneySave)), "Diese Stadt von unbegrenztem Geld zu normal begrenztem Geld konvertieren?\n" +
