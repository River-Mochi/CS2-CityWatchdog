    ...
    public sealed class LocaleZH_HANT : IDictionarySource
    {
            ...
            Dictionary<string, int> indexCounts)
        {
            ...
            Dictionary<string, string> entries = new Dictionary<string, string>
            {
                ...
                { m_Settings.GetOptionLabelLocaleID(nameof(Setting.UsageText)), "<顯示開關>\n" +
                ...
                { m_Settings.GetOptionDescLocaleID(nameof(Setting.MiniHudEnabled)), "在城市中顯示一個小型 HUD，顯示最重要的通知數量。\n" +
                    "可作為快速警告列使用，無需開啟完整的 City Watchdog 面板。" },

                { m_Settings.GetOptionLabelLocaleID(nameof(Setting.MiniHudMode)), "迷你HUD模式" },
                { m_Settings.GetOptionDescLocaleID(nameof(Setting.MiniHudMode)), "選擇迷你HUD使用哪些通知列。\n" +
                    "最活躍警告會顯示目前數量最高的項目。\n" +
                ...
                { m_Settings.GetOptionDescLocaleID(nameof(Setting.MiniHudItemCount)), "選擇迷你HUD一次最多顯示多少個通知圖示。" },

                { m_Settings.GetOptionLabelLocaleID(nameof(Setting.MiniHudOrientation)), "迷你HUD方向" },
                { m_Settings.GetOptionDescLocaleID(nameof(Setting.MiniHudOrientation)), "選擇迷你HUD圖示按列排列還是按欄排列。" },
                ...
                { m_Settings.GetOptionDescLocaleID(nameof(Setting.MiniHudPlacement)), "選擇迷你HUD出現的位置。\n" +
                    "可拖曳允許你在城市介面中移動它。" },
                ...
                { m_Settings.GetOptionDescLocaleID(nameof(Setting.MiniHudHideZero)), "啟用 [ ✓ ] 後，迷你HUD會隱藏數量為0的通知列。" },

                { m_Settings.GetOptionLabelLocaleID(nameof(Setting.MiniHudGlassStyle)), "玻璃風格" },
                { m_Settings.GetOptionDescLocaleID(nameof(Setting.MiniHudGlassStyle)), "在迷你HUD後方加入柔和的玻璃風背景，以提高可讀性。" },
