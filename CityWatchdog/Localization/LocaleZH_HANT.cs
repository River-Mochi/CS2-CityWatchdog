    ...
    public sealed class LocaleZH_HANT : IDictionarySource
    {
            ...
            Dictionary<string, int> indexCounts)
        {
            ...
            Dictionary<string, string> entries = new Dictionary<string, string>
            {
                ...
                { m_Settings.GetOptionTabLocaleID(CwdSettings.MoneyTab), "金錢-里程碑" },
                { m_Settings.GetOptionTabLocaleID(CwdSettings.About), "關於" },
                ...
                { m_Settings.GetOptionGroupLocaleID(CwdSettings.MoneyViewGroup), "城內資訊" },
                { m_Settings.GetOptionGroupLocaleID(CwdSettings.MiniHudGroup), "迷你HUD警報" },
                { m_Settings.GetOptionGroupLocaleID(CwdSettings.Milestone), "新城市開局設定" },
                { m_Settings.GetOptionGroupLocaleID(CwdSettings.Money), "金錢" },
                { m_Settings.GetOptionGroupLocaleID(CwdSettings.SaveConversion), "轉換無限金錢存檔" },
                { m_Settings.GetOptionGroupLocaleID(CwdSettings.AboutInfo), "" },
                { m_Settings.GetOptionGroupLocaleID(CwdSettings.AboutLinks), "" },
                { m_Settings.GetOptionGroupLocaleID(CwdSettings.AboutDiagnostics), "診斷" },
                ...
                { m_Settings.GetOptionLabelLocaleID(nameof(CwdSettings.ToggleNotificationsKeyboardBinding)), "切换警報圖示" },
                { m_Settings.GetOptionDescLocaleID(nameof(CwdSettings.ToggleNotificationsKeyboardBinding)),
                    "<快捷鍵>，作用同游戏内 <[全部切换]> 按钮。\n" +
                    "立即顯示或隱藏所有列出的城市警報圖示。" },
                { m_Settings.GetBindingKeyLocaleID(CwdSettings.ToggleNotificationsAction), "立即顯示/隱藏所有警報圖示" },
                ...
                { m_Settings.GetOptionLabelLocaleID(nameof(CwdSettings.PanelButtonsOnlyStart)), "僅按钮启动" },
                ...
                { m_Settings.GetOptionLabelLocaleID(nameof(CwdSettings.ToggleAllTooltipsKeyboardBinding)), "禁用全部懸停提示" },
                ...
                { m_Settings.GetBindingKeyLocaleID(CwdSettings.ToggleAllTooltipsAction), "隱藏/顯示游戏懸停提示" },
                ...
                { m_Settings.GetOptionDescLocaleID(nameof(CwdSettings.MoneyView)),
                    ...
                    "轻量懸停功能 <僅顯示>；\n" +
                    "省时间，也可能比開啟游戏資訊面板更轻。" },
                { m_Settings.GetOptionLabelLocaleID(nameof(CwdSettings.MoneyViewMode)), "金錢視圖 頻率" },
                ...
                { m_Settings.GetOptionDescLocaleID(nameof(CwdSettings.ApplyMiniHudRecommendedPreset)),
                    ...
                    "套裝包含：收藏、5 個圖示、直向、可拖曳、100% 大小、深色面板、隱藏數量為 0 的圖示。"
                  },
                ...
                { m_Settings.GetOptionDescLocaleID(nameof(CwdSettings.MiniHudMode)),
                    ...
                    "你可以選擇任意數量的收藏，\n" +
                    "但迷你面板只顯示該 **藍色星星** 清單中的前 5 或前 10 個。"
                  },
                ...
                { m_Settings.GetOptionDescLocaleID(nameof(CwdSettings.MiniHudHideZero)), "啟用 [ ✓ ] 时，迷你HUD隱藏計數为0的行。" },
                ...
                { m_Settings.GetOptionDescLocaleID(nameof(CwdSettings.AddMoneyKeyboardBinding)), "城市内 <新增金錢> 的快捷鍵。" },
                ...
                { m_Settings.GetOptionDescLocaleID(nameof(CwdSettings.SubtractMoneyKeyboardBinding)), "城市内 <減少金錢> 的快捷鍵。" },
                ...
                { m_Settings.GetOptionDescLocaleID(nameof(CwdSettings.ConfirmUnlimitedMoneySaveConversion)),
                    ...
                    "普通城市不需要此功能。" },
                { m_Settings.GetOptionLabelLocaleID(nameof(CwdSettings.ConvertUnlimitedMoneySave)), "把無限金錢城市转为普通" },
                ...
                { m_Settings.GetOptionWarningLocaleID(nameof(CwdSettings.ConvertUnlimitedMoneySave)),
                    ...
                    "确定吗？" },
                { m_Settings.GetOptionLabelLocaleID(nameof(CwdSettings.NameText)), "Mod名稱" },
                { m_Settings.GetOptionDescLocaleID(nameof(CwdSettings.NameText)), "此Mod的顯示名稱。" },
                { m_Settings.GetOptionLabelLocaleID(nameof(CwdSettings.VersionText)), "版本" },
                { m_Settings.GetOptionDescLocaleID(nameof(CwdSettings.VersionText)), "目前Mod版本。" },
                ...
                { m_Settings.GetOptionLabelLocaleID(nameof(CwdSettings.WriteNotificationAuditLog)), "除錯報告到日誌" },
