    ...
    public sealed class LocaleZH_HANT : IDictionarySource
    {
            ...
            Dictionary<string, int> indexCounts)
        {
            ...
            Dictionary<string, string> entries = new Dictionary<string, string>
            {
                ...
                { m_Settings.GetOptionTabLocaleID(CwdSettings.MoneyTab), "城市開局" },
                ...
                { m_Settings.GetOptionLabelLocaleID(nameof(CwdSettings.UsageText)),
                    ...
                    "\n" +
                    "<自訂里程碑>\n" +
                    "城市開局 > 新城市開局設定，可在載入/開始城市前設定初始金錢或里程碑。" },
                ...
                { m_Settings.GetOptionDescLocaleID(nameof(CwdSettings.InitialMoney)),
                    "設定新 <有限金錢> 城市或第一個載入城市的起始餘額，\n" +
                    "套用後會重設為遊戲預設。\n" +
                    "如果城市已載入則變灰。\n" +
                    "在載入/開始前設定。之後使用 <金錢快捷鍵金額> 或 <自動金錢>。" },
