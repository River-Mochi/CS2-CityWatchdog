    ...
    public sealed class LocaleKO : IDictionarySource
    {
            ...
            Dictionary<string, int> indexCounts)
        {
            ...
            Dictionary<string, string> entries = new Dictionary<string, string>
            {
                ...
                { m_Settings.GetOptionGroupLocaleID(CwdSettings.MoneyViewGroup), "도시 정보 보기" },
                { m_Settings.GetOptionGroupLocaleID(CwdSettings.MiniHudGroup), "미니 HUD 알림" },
                { m_Settings.GetOptionGroupLocaleID(CwdSettings.Milestone), "새 도시 시작 설정" },
                { m_Settings.GetOptionGroupLocaleID(CwdSettings.Money), "돈" },
                { m_Settings.GetOptionGroupLocaleID(CwdSettings.SaveConversion), "무제한 저장 변환" },
                { m_Settings.GetOptionGroupLocaleID(CwdSettings.AboutInfo), "" },
                { m_Settings.GetOptionGroupLocaleID(CwdSettings.AboutLinks), "" },
                { m_Settings.GetOptionGroupLocaleID(CwdSettings.AboutDiagnostics), "진단" },
                ...
                { m_Settings.GetBindingKeyLocaleID(CwdSettings.ToggleNotificationsAction), "모든 알림 아이콘 즉시 표시/숨김" },
