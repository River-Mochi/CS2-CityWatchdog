    ...
    public sealed class LocaleKO : IDictionarySource
    {
            ...
            Dictionary<string, int> indexCounts)
        {
            ...
            Dictionary<string, string> entries = new Dictionary<string, string>
            {
                ...
                { m_Settings.GetOptionLabelLocaleID(nameof(Setting.PanelButtonsOnlyStart)), "버튼만 보기로 시작" },
                { m_Settings.GetOptionDescLocaleID(nameof(Setting.PanelButtonsOnlyStart)),
                    "켜면 [ ✓ ], 왼쪽 위 버튼으로 City Watchdog을 열 때 작은 버튼 전용 보기로 시작합니다.\n" +
                    "제목 표시줄 화살표나 행 수 버튼으로 전체 패널을 펼칠 수 있습니다." },
                ...
                { m_Settings.GetOptionDescLocaleID(nameof(Setting.MiniHudEnabled)),
                    "중요한 알림 수를 보여 주는 작은 도시 내 HUD를 표시합니다.\n" +
                ...
                { m_Settings.GetOptionDescLocaleID(nameof(Setting.ApplyMiniHudRecommendedPreset)),
                    "추천 Mini HUD 설정을 적용합니다.\n" +
                    "상위 활성 알림, 아이콘 5개, 세로, 드래그 가능, 0 숨김, 유리 스타일.\n" +
                    "드래그 가능한 세로 프리셋은 오른쪽 위 근처에서 시작합니다." },
                ...
                { m_Settings.GetOptionDescLocaleID(nameof(Setting.MiniHudItemCount)),
                    "미니 HUD가 한 번에 표시할 수 있는 알림 아이콘 수를 선택합니다." },
                ...
                { m_Settings.GetOptionDescLocaleID(nameof(Setting.MiniHudOrientation)),
                    "미니 HUD 아이콘을 가로 또는 세로로 배치할지 선택합니다." },
                ...
                { m_Settings.GetOptionDescLocaleID(nameof(Setting.MiniHudHideZero)),
                    "활성화 [ ✓ ] 시, 미니 HUD는 수가 0인 알림 행을 숨깁니다." },
                ...
                { m_Settings.GetOptionDescLocaleID(nameof(Setting.MiniHudGlassStyle)),
                    "가독성을 위해 미니 HUD 뒤에 부드러운 유리 느낌 배경을 추가합니다." },
