            ...
            Dictionary<string, int> indexCounts)
        {
            ...
            Dictionary<string, string> entries = new Dictionary<string, string>
            {
                ...
                { m_Settings.GetOptionDescLocaleID(nameof(Setting.PanelButtonsOnlyStart)),
                    "Gdy włączone [ ✓ ], przycisk w lewym górnym rogu otwiera City Watchdog w małym widoku samych przycisków.\n" +
                    "Użyj strzałki na pasku tytułu albo przycisku liczby wierszy, aby rozwinąć pełny panel." },
                ...
                { m_Settings.GetOptionDescLocaleID(nameof(Setting.MiniHudEnabled)),
                    "Pokazuje mały HUD w mieście z najważniejszymi licznikami powiadomień.\n" +
                    "Używaj go jako szybkiego paska alertów bez otwierania pełnego panelu City Watchdog." },

                { m_Settings.GetOptionLabelLocaleID(nameof(Setting.ApplyMiniHudRecommendedPreset)), "Zalecany preset" },
                { m_Settings.GetOptionDescLocaleID(nameof(Setting.ApplyMiniHudRecommendedPreset)),
                    "Ustawia zalecany Mini HUD:\n" +
                    "najaktywniejsze alerty, 5 ikon, pionowo, przeciągalny, ukryj zera i styl szkła.\n" +
                    "Pionowy przeciągalny preset startuje blisko prawego górnego rogu." },

                { m_Settings.GetOptionLabelLocaleID(nameof(Setting.MiniHudMode)), "Tryb Mini HUD" },
                { m_Settings.GetOptionDescLocaleID(nameof(Setting.MiniHudMode)),
                    "Wybierz, których wierszy powiadomień używa Mini HUD.\n" +
                ...
                { m_Settings.GetOptionDescLocaleID(nameof(Setting.MiniHudItemCount)),
                    "Wybierz, ile ikon powiadomień Mini HUD może pokazać naraz." },
                ...
                { m_Settings.GetOptionDescLocaleID(nameof(Setting.MiniHudOrientation)),
                    "Wybierz, czy ikony Mini HUD są ułożone w rzędzie czy w kolumnie." },
                ...
                { m_Settings.GetOptionDescLocaleID(nameof(Setting.MiniHudHideZero)),
                    "Gdy włączone [ ✓ ], Mini HUD ukrywa wiersze powiadomień z liczbą 0." },
                ...
                { m_Settings.GetOptionDescLocaleID(nameof(Setting.MiniHudGlassStyle)),
                    "Dodaje miękkie tło w stylu szkła za Mini HUD dla lepszej czytelności." },
