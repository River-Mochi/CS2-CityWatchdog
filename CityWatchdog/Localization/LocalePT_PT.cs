    ...
    public sealed class LocalePT_PT : IDictionarySource
    {
            ...
            Dictionary<string, int> indexCounts)
        {
            ...
            Dictionary<string, string> entries = new Dictionary<string, string>
            {
                ...
                { m_Settings.GetOptionGroupLocaleID(Setting.MoneyViewGroup), "Visualizador de info na cidade" },
                ...
                { m_Settings.GetOptionDescLocaleID(nameof(Setting.PanelButtonsOnlyStart)),
                    "Quando activo [ ✓ ], o City Watchdog abre primeiro na vista pequena só com botões.\n" +
                ...
                { m_Settings.GetOptionDescLocaleID(nameof(Setting.MiniHudHideZero)),
                    "Quando activo [ ✓ ], o Mini HUD oculta linhas com contagem 0." },
                ...
                { m_Settings.GetOptionDescLocaleID(nameof(Setting.AutomaticAddMoney)),
                    "Quando activo [ ✓ ], o City Watchdog verifica o saldo da cidade.\n" +
