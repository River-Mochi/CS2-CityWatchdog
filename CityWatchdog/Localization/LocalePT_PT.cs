    ...
    public sealed class LocalePT_PT : IDictionarySource
    {
            ...
            Dictionary<string, int> indexCounts)
        {
            ...
            Dictionary<string, string> entries = new Dictionary<string, string>
            {
                ...
                { m_Settings.GetOptionGroupLocaleID(CwdSettings.Milestone), "INÍCIO DE NOVA CIDADE" },
                { m_Settings.GetOptionGroupLocaleID(CwdSettings.Money), "Dinheiro" },
                { m_Settings.GetOptionGroupLocaleID(CwdSettings.SaveConversion), "Converter gravação ilimitada" },
                ...
                { m_Settings.GetOptionLabelLocaleID(nameof(CwdSettings.UsageText)),
                    ...
                    "\n" +
                    "<Marco personalizado>\n" +
                    "Nova cidade > INÍCIO DE NOVA CIDADE define o capital inicial e/ou os marcos antes de carregar/iniciar." },
