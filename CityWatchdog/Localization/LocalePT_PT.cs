            ...
            Dictionary<string, int> indexCounts)
        {
            ...
            Dictionary<string, string> entries = new Dictionary<string, string>
            {
                ...
                { m_Settings.GetOptionDescLocaleID(nameof(Setting.PanelButtonsOnlyStart)),
                    "Quando ativo [ ✓ ], o botão no canto superior esquerdo abre o City Watchdog na vista pequena só com botões.\n" +
                    "Usa a seta da barra de título ou o botão de linhas para abrir o painel completo." },
