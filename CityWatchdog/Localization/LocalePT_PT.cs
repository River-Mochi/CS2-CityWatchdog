            ...
            Dictionary<string, int> indexCounts)
        {
            ...
            Dictionary<string, string> entries = new Dictionary<string, string>
            {
                ...
                { m_Settings.GetOptionDescLocaleID(nameof(Setting.DisableAllTooltips)),
                    "Desativa as tooltips do jogo ao passar o rato — tanto as que seguem o cursor sobre edifícios/cidadãos/ferramentas\n" +
                    " como os pequenos popups nos botões da UI do jogo (nomes da barra superior, botões vanilla, etc.).\n" +
                    "<Os popups próprios de dinheiro/população do City Watchdog ficam ligados>; são controlados pela opção Money View acima.\n" +
