    ...
    public sealed class LocaleZH_HANS : IDictionarySource
    {
            ...
            Dictionary<string, int> indexCounts)
        {
            ...
            Dictionary<string, string> entries = new()
            {
                ...
                { m_Settings.GetOptionGroupLocaleID(CwdSettings.MoneyViewGroup), "城内信息" },
                { m_Settings.GetOptionGroupLocaleID(CwdSettings.MiniHudGroup), "迷你HUD警报" },
                { m_Settings.GetOptionGroupLocaleID(CwdSettings.Milestone), "新城市开局设置" },
                { m_Settings.GetOptionGroupLocaleID(CwdSettings.Money), "金钱" },
                { m_Settings.GetOptionGroupLocaleID(CwdSettings.SaveConversion), "转换无限金钱存档" },
                { m_Settings.GetOptionGroupLocaleID(CwdSettings.AboutInfo), "" },
                { m_Settings.GetOptionGroupLocaleID(CwdSettings.AboutLinks), "" },
                { m_Settings.GetOptionGroupLocaleID(CwdSettings.AboutDiagnostics), "诊断" },
