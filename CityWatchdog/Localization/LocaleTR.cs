    ...
    public sealed class LocaleTR : IDictionarySource
    {
            ...
            Dictionary<string, int> indexCounts)
        {
            ...
            Dictionary<string, string> entries = new Dictionary<string, string>
            {
                ...
                { m_Settings.GetOptionLabelLocaleID(nameof(Setting.UsageText)), "<Görüntü anahtarları>\n" +
                ...
                { m_Settings.GetOptionDescLocaleID(nameof(Setting.ToggleNotificationsKeyboardBinding)), "Oyundaki <[TOGGLE ALL]> düğmesiyle aynı işlem için <kısayol>.\n" +
                ...
                { m_Settings.GetOptionDescLocaleID(nameof(Setting.ToggleNotificationPanelKeyboardBinding)), "Şehir içinde\n" +
                ...
                { m_Settings.GetOptionDescLocaleID(nameof(Setting.ToggleRoadNamesKeyboardBinding)), "Vanilla yol adı etiketlerini anında gizler veya gösterir.\n" +
                ...
                { m_Settings.GetOptionDescLocaleID(nameof(Setting.ToggleAllTooltipsKeyboardBinding)), "Binalar, vatandaşlar, araçlar ve alt menü ikonları dahil oyundaki TÜM hover ipuçlarını gizler veya gösterir.\n" +
                ...
                { m_Settings.GetOptionDescLocaleID(nameof(Setting.MoneyView)), "<Önerilir>\n" +
                ...
                { m_Settings.GetOptionDescLocaleID(nameof(Setting.MoneyViewMode)), "Para ve nüfus trend yazısının saatlik mi aylık mı gösterileceğini seçin.\n" +
                ...
                { m_Settings.GetOptionDescLocaleID(nameof(Setting.MoneyTooltipMode)), "Para hover ipucunda ne kadar ayrıntı görüneceğini seçin.\n" +
                ...
                { m_Settings.GetOptionDescLocaleID(nameof(Setting.MoneyTooltipFontScale)), "Money View sayılarının <yazı boyutunu> ayarlar.\n" +
                ...
                { m_Settings.GetOptionDescLocaleID(nameof(Setting.MiniHudEnabled)), "En önemli bildirim sayılarını gösteren küçük bir şehir içi HUD gösterir.\n" +
                ...
                { m_Settings.GetOptionDescLocaleID(nameof(Setting.MiniHudMode)), "Mini HUD'un hangi bildirim satırlarını kullanacağını seçin.\n" +
                ...
                { m_Settings.GetOptionDescLocaleID(nameof(Setting.MiniHudItemCount)), "Mini HUD'un aynı anda kaç bildirim simgesi göstereceğini seçin." },

                { m_Settings.GetOptionLabelLocaleID(nameof(Setting.MiniHudOrientation)), "Mini HUD yönü" },
                { m_Settings.GetOptionDescLocaleID(nameof(Setting.MiniHudOrientation)), "Mini HUD simgelerinin satır mı sütun mu olacağını seçin." },
                ...
                { m_Settings.GetOptionDescLocaleID(nameof(Setting.MiniHudPlacement)), "Mini HUD'un nerede görüneceğini seçin.\n" +
                ...
                { m_Settings.GetOptionDescLocaleID(nameof(Setting.MiniHudGlassStyle)), "Okunabilirlik için Mini HUD arkasına yumuşak cam benzeri bir arka plan ekler." },
                ...
                { m_Settings.GetOptionDescLocaleID(nameof(Setting.CustomMilestone)), "Seçilen milestone’u şehir yüklendikten hemen sonra açmak için <şehri yüklemeden veya başlatmadan önce> etkinleştirin.\n" +
                ...
                { m_Settings.GetOptionDescLocaleID(nameof(Setting.MilestoneLevel)), "Bir sonraki şehir yüklemesinde açılacak milestone’u seçin.\n" +
                ...
                { m_Settings.GetOptionDescLocaleID(nameof(Setting.ManualMoneyAmount)), "Para Ekle ve Para Çıkar kısayolları ile bu miktar kullanılır.\n" +
                ...
                { m_Settings.GetOptionDescLocaleID(nameof(Setting.AutomaticAddMoney)), "Etkin [ ✓ ] olduğunda City Watchdog, şehir yüklüyken bakiyeyi kontrol eder.\n" +
                ...
                { m_Settings.GetOptionDescLocaleID(nameof(Setting.AutomaticAddMoneyThreshold)), "Otomatik para açıksa ve bakiye bu değerin altına düşerse,\n" +
                    "seçilen otomatik miktarı ekler." },

                { m_Settings.GetOptionLabelLocaleID(nameof(Setting.AutomaticAddMoneyAmount)), "Otomatik para miktarı" },
                { m_Settings.GetOptionDescLocaleID(nameof(Setting.AutomaticAddMoneyAmount)), "Otomatik tetiklendiğinde eklenen miktar.\n" +
                ...
                { m_Settings.GetOptionDescLocaleID(nameof(Setting.ConfirmUnlimitedMoneySaveConversion)), "<ÖNCE şehir yedeği alın>.\n" +
                ...
                { m_Settings.GetOptionDescLocaleID(nameof(Setting.WriteNotificationAuditLog)), "<Normal oyun için gerekmez.>\n" +
