    ...
    public sealed class LocalePT_BR : IDictionarySource
    {
            ...
            Dictionary<string, int> indexCounts)
        {
            ...
            Dictionary<string, string> entries = new Dictionary<string, string>
            {
                ...
                { m_Settings.GetOptionGroupLocaleID(Setting.SaveConversion), "Converter salvamento ilimitado" },
                ...
                { m_Settings.GetOptionLabelLocaleID(nameof(Setting.UsageText)), "<Controles visuais>\n" +
                    ...
                    "Visualização de dinheiro adiciona tendências de dinheiro/população e detalhes ao passar o mouse.\n" +
                    "\n" +
                    "<Marco personalizado>\n" +
                ...
                { m_Settings.GetOptionDescLocaleID(nameof(Setting.ToggleAllTooltipsKeyboardBinding)), "<Atalho> para ocultar/mostrar TODAS as dicas do jogo.\n" +
                    "<Popups de dinheiro/população do City Watchdog ficam ativos>; são controlados pela Visualização de dinheiro.\n" +
                ...
                { m_Settings.GetOptionDescLocaleID(nameof(Setting.MoneyViewMode)), "Escolha tendências por hora ou por mês no menu inferior.\n" +
                ...
                { m_Settings.GetOptionDescLocaleID(nameof(Setting.MoneyTooltipMode)), "Escolha quanto detalhe aparece na dica de dinheiro.\n" +
                ...
                { m_Settings.GetOptionDescLocaleID(nameof(Setting.MoneyTooltipFontScale)), "Ajusta o <tamanho da fonte> dos números do Visualização de dinheiro.\n" +
                    "Padrão do jogo = 100%\n" +
                    "<Padrão do mod = 120%>\n" +
                ...
                { m_Settings.GetOptionDescLocaleID(nameof(Setting.MiniHudMode)), "Escolha quais linhas o Mini HUD usa.\n" +
                ...
                { m_Settings.GetOptionDescLocaleID(nameof(Setting.MiniHudPlacement)), "Escolha onde o Mini HUD aparece.\n" +
                ...
                { m_Settings.GetOptionDescLocaleID(nameof(Setting.MiniHudPanelStyle)), "Escolha o fundo do Mini HUD.\n" +
                    "Vidro vai de claro a branco nublado; não fica mais escuro.\n" +
                    "Use painel escuro para um HUD no estilo do jogo, mais escuro." },
                ...
                { m_Settings.GetOptionDescLocaleID(nameof(Setting.MilestoneLevel)), "Escolha o marco para liberar no próximo carregamento.\n" +
                ...
                { m_Settings.GetOptionDescLocaleID(nameof(Setting.ManualMoneyAmount)), "Use este valor com os atalhos Adicionar e Subtrair dinheiro.\n" +
                ...
                { m_Settings.GetOptionDescLocaleID(nameof(Setting.ConfirmUnlimitedMoneySaveConversion)), "<Faça backup PRIMEIRO>.\n" +
                    ...
                    "Libera o botão <[Converter salvamento de Dinheiro ilimitado]> se a cidade carregada for <Dinheiro ilimitado>.\n" +
                ...
                { m_Settings.GetOptionDescLocaleID(nameof(Setting.ConvertUnlimitedMoneySave)), "Para cidades iniciadas com <Dinheiro ilimitado>.\n" +
                    "Com a cidade carregada, converte o salvamento para orçamento normal.\n" +
