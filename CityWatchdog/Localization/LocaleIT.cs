    ...
    public sealed class LocaleIT : IDictionarySource
    {
            ...
            Dictionary<string, int> indexCounts)
        {
            ...
            Dictionary<string, string> entries = new Dictionary<string, string>
            {
                ...
                { m_Settings.GetOptionTabLocaleID(Setting.MoneyTab), "Denaro"},
                { m_Settings.GetOptionTabLocaleID(Setting.Hotkeys), "Scorciatoie"},
                ...
                { m_Settings.GetOptionGroupLocaleID(Setting.HotkeyActions), "Scorciatoie"},
                ...
                { m_Settings.GetOptionLabelLocaleID(nameof(Setting.UsageText)),
                    "<Interruttori display>\n" +
                    "1. Pulsante [i]: nasconde/mostra TUTTI i tooltip del gioco: edifici, cittadini, strumenti e icone del menu in basso.\n" +
                    "2. Pulsante nomi strade: nasconde/mostra i nomi delle strade. Tasto rapido: \\.\n" +
                    "3. Pulsante frecce stradali: forza le frecce delle strade a senso unico (nasconde anche i nomi).\n" +
                    "4. Icona CWD nella barra titolo: mostra/nasconde i tooltip del pannello City Watchdog.\n" +
                    "\n" +
                    "<Avvisi di notifica>\n" +
                    "1. Clicca il pulsante City Watchdog in alto a sinistra, o premi Shift+N, per aprire il pannello.\n" +
                    "2. Pulsante ordina crescente/decrescente.\n" +
                    "3. Toggle All spegne/accende tutto rapidamente, oppure apri una sezione per scegliere singole icone.\n" +
                    "4. Nasconde solo le icone; non risolve il problema della città.\n" +
                    "\n" +
                    "<Aiuti denaro>\n" +
                    "1. Aggiungi o sottrai denaro con i tasti predefiniti [ e ].\n" +
                    "2. Il denaro automatico aggiunge fondi quando la città scende sotto il limite scelto.\n" +
                    "3. Converti denaro illimitato serve solo per città avviate con Denaro illimitato e <non è reversibile>.\n" +
                    "\n" +
                    "<Tooltip menu inferiore>\n" +
                    "Money View aggiunge trend a denaro e popolazione e dettagli al passaggio del mouse.\n" +
                    "\n" +
                    "<Milestone personalizzato>\n" +
                    "Imposta denaro iniziale e milestone da IMPOSTAZIONI NUOVA CITTÀ prima di caricare o iniziare una città."},
